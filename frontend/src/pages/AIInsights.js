...
export default function AIInsights() {
  ...
  const renderFormattedMessage = (content) => {
    ...
    const isHeading = (line) => {
      ...
      const lowerLine = line
        ...
        .replace(/[📊💡✅🎯📈💰🔍:]/g, "")
        .trim();
      return headingKeywords.some(
        (keyword) => lowerLine === keyword || lowerLine.endsWith(keyword),
      );
    };
        ...
        if (cleanText && cleanText.length > 1) {
          ...
          elements.push(
            ...
            >
              ...
              <span style={{ lineHeight: "1.6", paddingTop: "2px" }}>
                {cleanText}
              </span>
            </div>,
          );
  ...
  const quickPrompts = [
    {
      ...
      query: "Analyze my spending patterns and provide detailed insights",
    },
    {
      emoji: "💡",
      text: "Budget Tips",
      query: "Provide budget recommendations based on my financial situation",
    },
    {
      emoji: "💰",
      text: "Save Money",
      query: "Give me practical tips to save more money monthly",
    },
    {
      emoji: "📈",
      text: "Investment Tips",
      query: "What investment strategies would you recommend for me?",
    },
  ];
  ...
  const sendMessage = async (message = chatInput) => {
    ...
    setChatMessages((prev) => [
      ...prev,
      { type: "user", content: finalMessage },
    ]);
    setChatInput("");
    setLoading(true);

    try {
      console.log("🔗 Calling Groq API endpoint: /api/ai/insights");
      ...
      setChatMessages((prev) => [
        ...prev,
        {
          type: "ai",
          content:
            "Sorry, I'm having trouble connecting to the AI service. Please check your Groq API key and internet connection, then try again.",
        },
      ]);
    } finally {
      setLoading(false);
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              {[
                ...
                },
                {
                  ...
                  bgGradient: isDarkMode
                    ? "linear-gradient(135deg, rgba(99, 102, 241, 0.15) 0%, rgba(129, 140, 248, 0.1) 100%)"
              ...
              {[
                {
                  ...
                  borderColor: "#6366f1",
                  textColor: isDarkMode ? "#c7d2fe" : "#4f46e5",
                  hoverShadow: "rgba(99, 102, 241, 0.2)",
                },
                {
                  ...quickPrompts[1],
                  gradient: isDarkMode
                    ? "linear-gradient(135deg, rgba(245, 158, 11, 0.35) 0%, rgba(249, 115, 22, 0.25) 100%)"
                ...
                },
                {
                  ...quickPrompts[2],
                  gradient: isDarkMode
                    ? "linear-gradient(135deg, rgba(16, 185, 129, 0.35) 0%, rgba(20, 184, 166, 0.25) 100%)"
                    : "linear-gradient(135deg, rgba(16, 185, 129, 0.12) 0%, rgba(20, 184, 166, 0.08) 100%)",
                  borderColor: "#10b981",
                  textColor: isDarkMode ? "#a7f3d0" : "#047857",
                  hoverShadow: "rgba(16, 185, 129, 0.2)",
                },
                {
                  ...quickPrompts[3],
                  gradient: isDarkMode
                    ? "linear-gradient(135deg, rgba(236, 72, 153, 0.35) 0%, rgba(244, 63, 94, 0.25) 100%)"
                    : "linear-gradient(135deg, rgba(236, 72, 153, 0.12) 0%, rgba(244, 63, 94, 0.08) 100%)",
                  borderColor: "#ec4899",
                  textColor: isDarkMode ? "#fbcfe8" : "#be185d",
