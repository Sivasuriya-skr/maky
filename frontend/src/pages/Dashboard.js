...
export default function Dashboard() {
  const { user } = useAuth();
  const { transactions, loading, loadTransactions } =
      ...
      <div
        ...
        style={{
          ...
          boxShadow: isDarkMode
            ? "0 10px 40px rgba(30, 41, 59, 0.5), 0 0 60px rgba(99, 102, 241, 0.1)"
            : "0 8px 32px rgba(99, 102, 241, 0.2), 0 0 60px rgba(129, 140, 248, 0.15)",
        }}
      >
        ...
        <div
          style={{
            ...
            background: isDarkMode
              ...
              : "radial-gradient(circle, rgba(165, 180, 252, 0.5) 0%, rgba(129, 140, 248, 0.3) 40%, transparent 70%)",
            borderRadius: "50%",
        ...
        <div
          style={{
            ...
            background: isDarkMode
              ...
              : "radial-gradient(circle, rgba(199, 210, 254, 0.6) 0%, rgba(165, 180, 252, 0.3) 50%, transparent 70%)",
            borderRadius: "50%",
        ...
        <div
          style={{
            ...
            background: isDarkMode
              ...
              : "radial-gradient(circle, rgba(224, 231, 255, 0.7) 0%, transparent 70%)",
            borderRadius: "50%",
      ...
      <div className="dashboard-stats">
        ...
        <div className="card stat-card">
          ...
          <div className="stat-change income">
            📈 {summary.savingsRate}% vs last month
          </div>
        </div>
        ...
        <div className="card stat-card">
          ...
          <div className="stat-change" style={{ color: "#6b7280" }}>
        ...
        <div className="card insights-card">
          ...
          <div className="insights-list">
            <div className="insight-item">
              ...
              <p>
                Consider setting a budget for housing costs to reduce spending
                in this category, aiming to lower it below $25000, which could
                free up additional funds for savings or investment.
              </p>
            </div>
            <div className="insight-item">
              <span className="insight-number">2</span>
              <p>
                With a savings rate of {summary.savingsRate}%, look into
                diversifying savings by investing in stocks, bonds, or mutual
                funds to potentially increase returns.
              </p>
            </div>
            <div className="insight-item">
              <span className="insight-number">3</span>
              <p>
                Evaluate expenses regularly and seek opportunities to reduce
                discretionary spending, allowing for an increased ability to
                invest or save more aggressively for future goals.
              </p>
            </div>
          </div>
        </div>
